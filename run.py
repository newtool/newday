...
#天气预报
sojsonurl = 'http://t.weather.sojson.com/api/weather/city/101030100'
...
#生活提醒
isoyuurl = 'http://api.isoyu.com/api/Weather/get_weather?city=你的城市'
...
def sendHtml_email(msg):
    ...
    message['to'] = '发送到的邮箱'
    password = "smtp授权码"
    message['subject'] = Header(u'邮件标题', 'utf-8').encode()
    smtp_server = "smtp地址"
    server = smtplib.SMTP(smtp_server, 25)  # SMTP协议默认端口是25
    # 打印出和SMTP服务器交互的所有信息。
    #server.set_debuglevel(1)
    # 登录SMTP服务器
    server.login('你的邮箱', password)
